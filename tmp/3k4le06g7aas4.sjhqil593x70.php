...
<head>
    ...
    <meta name="description" content="Электронные книги и учебники на разные тематики.">
    <meta name="keywords" content="Books, online, ibooks, online, exams, python, c++,учебники, школьные, электронные учебники, библиотека, онлайн">
...
<!-- Поиск от Яндекса по сайту. -->
    <div class="container">
<div class="ya-site-form ya-site-form_inited_no" onclick="return {'action':'https://library.sviridovden.ru/search','arrow':true,'bg':'#ffcc00','fontsize':12,'fg':'#000000','language':'ru','logo':'rb','publicname':'Поиск по библиотеке','suggest':true,'target':'_blank','tld':'ru','type':2,'usebigdictionary':false,'searchid':2336062,'input_fg':'#000000','input_bg':'#ffffff','input_fontStyle':'normal','input_fontWeight':'normal','input_placeholder':'Я.Поиск по сайту.','input_placeholderColor':'#ff0000','input_borderColor':'#7f9db9'}"><form action="https://yandex.ru/search/site/" method="get" target="_blank" accept-charset="utf-8"><input type="hidden" name="searchid" value="2336062"/><input type="hidden" name="l10n" value="ru"/><input type="hidden" name="reqenc" value=""/><input type="search" name="text" value=""/><input type="submit" value="Я.Поиск" placeholder="Я.Поиск"/></form></div>
<style type="text/css">
.ya-page_js_yes .ya-site-form_inited_no { display: none !important; text-transform: uppercase!important }
</style>
...
-->
        ...
        <div class="row">
            <div class="pagination col-sm-10">
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center pagination " style="margin: 50px auto; ">
